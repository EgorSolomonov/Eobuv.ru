...
$this->addExternalJS("https://cdn.jsdelivr.net/gh/cdek-it/widget@latest/dist/cdek-widget.umd.js");
    ...
    <div class="basket">
        <div class="basket__left">
            <section class="basket__items">
                ...
                <!-- <pre><? var_dump($arResult['BASKET_ITEMS']) ?></pre> -->
                    ...
                    <div class="basket__item" data-id="<?= $arTovar['ID'] ?>">
                        ...
                        <div class="basket__item__info">
                            ...
                            <div class="basket__item__block basket__item__action">
                                <? // Добавил quantity-id для поиска в ajax условии 
                                ?>
                                <div class="item__quantity" quantity-id="<?= $arTovar['PRODUCT_ID'] ?>">
                                    ...
                                    <div class="item__quantity__minus">
                                        <button data-update class="js-count-minus">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                                                <path fill="#767676" fill-rule="evenodd" clip-rule="evenodd" d="M17 3a1 1 0 01-1 1H8a1 1 0 110-2h8a1 1 0 011 1z"></path>
                                            </svg>
                                        </button>
                                    </div>
                                    <div class="item__quantity__value">
                                        <? // Добавил quantity-id для поиска в ajax условии 
                                        ?>
                                        <input data-update class="js-count-input cart-item-count__control" readonly value="<?= $arTovar['QUANTITY'] ?>" data-id="<?= $arTovar['ID'] ?>" quantity-id="<?= $arTovar['PRODUCT_ID'] ?>" maxlength="99" type="text">
                                    </div>
                                    <div class="item__quantity__plus">
                                        <button data-update class="js-count-plus">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                                                <path fill="#767676  " fill-rule="evenodd" clip-rule="evenodd" d="M13 8a1 1 0 10-2 0v3H8a1 1 0 100 2h3v3a1 1 0 102 0v-3h3a1 1 0 100-2h-3V8z"></path>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
            ...
            <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
                ...
                <div id="bx-soa-order" class="checkout-steps" style="opacity: 0">
                    <!--	MAIN BLOCK	-->
                    <div class="bx-soa">
                        <div id="bx-soa-main-notifications" class="bx-step-error">
                    ...
                    <div class="checkout-steps">
                        ...
                        <section class="order__delivery checkout-step" id="bx-soa-delivery">
                            <div class="section__title">
                                <span>Способы доставки</span>
                            </div>
                            <!-- ТУТ САМИ ИНПУТЫ, рендерятся в JS -->
                            <div class="delivery__data__inputs js-delivery-content" id="js-delivery-content">
                                <div class="js-delivery-items-container delivery__data__inputs">

                                </div>
                            </div>
                        </section>

                        <section class="checkout-step js-checkout-step-delivery">
                        ...
                        <section class="checkout-step" id="bx-soa-pickup" style="display: none">
                            <div class="section__title">
                        ...
                        <section class="checkout-step" id="bx-soa-paysystem">
                            <div class="checkout-step__body checkout-step__body--payment">
                                ...
                                <div class="payment-types payment__data__inputs js-pay-system-items-container"></div>
                            </div>
                        </section>
                    </div>
                </div>
            ...
            <div class="promocode <?= !empty($arResult['ACTIVE_COUPON']) ? '' : 'promo__empty' ?>">
                <div class="promocode__title">
                    Промокод:
                </div>
                <div data-update class="promocode__value">
                    <?= $arResult['ACTIVE_COUPON']['COUPON'] ?>
                </div>
                <div data-update class="promocode__delete js-delete-coupon" data-id="<?= $arResult['ACTIVE_COUPON']['COUPON'] ?>">
                    Удалить
                </div>
            </div>
            ...
            <div class="basket__cart__panel" id="cart-panel">
                <div class="cart__panel__items">
                    ...
                    <!-- <div class="cart__panel__item cart__panel__discount--card">
                                ...
                                -->
                    <div class="cart__panel__item cart__panel__discount <?= $arResult['BASKET_PRICE_DISCOUNT_DIFF_VALUE'] > 0 && !(abs($arResult['BASKET_PRICE_DISCOUNT_DIFF_VALUE'] - $arResult['DK_PRICE']) < 0.00001) ? '' : 'discount__empty' ?>">
                        <div class="cart__panel__item__text">
                            Скидка
                        </div>
                        <div data-update class="cart__panel__item__value cart__panel__discount__value <?= $arResult['BASKET_PRICE_DISCOUNT_DIFF_VALUE'] > 0 && !(abs($arResult['BASKET_PRICE_DISCOUNT_DIFF_VALUE'] - $arResult['DK_PRICE']) < 0.00001) ? '' : 'discount__empty' ?>">
                            - <?= $arResult['BASKET_PRICE_DISCOUNT_DIFF_VALUE'] ?> руб.
                        </div>
                    </div>
                    <div class="cart__panel__item cart__panel__discountDK <?= $arResult['DK_PRICE'] > 0 ? '' : 'discountDK__empty' ?>">
                        <div class="cart__panel__item__text">
                            Скидка по карте
                        </div>
                        <div data-update class="cart__panel__item__value cart__panel__discountDK__value <?= $arResult['DK_PRICE'] > 0 ? '' : 'discountDK__empty' ?>">
                            - <?= $arResult['DK_PRICE'] ?> руб.
                        </div>
                    </div>
