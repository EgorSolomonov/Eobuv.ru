...
$APPLICATION->SetTitle("Сток-распродажа");

$res = AllStokProductDiscount::getFull(
...
if (empty($_GET) && $_COOKIE['prev_page'] !== $APPLICATION->GetCurDir()) {
	$_GET['SORT'] = 'CATALOG_PRICE_SCALE_7-ASC';
}

$GLOBALS['arrFilter'] = array("ID" => $sale_id, "!PREVIEW_PICTURE" => false,  ">=CATALOG_QUANTITY" => 2);
?>
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"DISPLAY_TOP_PAGER" => "N",
		"ELEMENT_SORT_FIELD" => "show_counter_start",
		...
		"PRICE_CODE" => array("Цена интернет магазина со скидкой"),
		"PRICE_VAT_INCLUDE" => "Y",
		...
		"SEF_FOLDER" => "/stok/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("compare" => "compare/", "element" => "#SECTION_CODE_PATH#/art-#ELEMENT_CODE#/", "section" => "#SECTION_CODE_PATH#/", "sections" => "", "smart_filter" => "#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
